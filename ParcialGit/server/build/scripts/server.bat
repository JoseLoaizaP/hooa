...
set CLASSPATH=%APP_HOME%\lib\server.jar;%APP_HOME%\lib\gson-2.13.2.jar;%APP_HOME%\lib\h2-2.4.240.jar;%APP_HOME%\lib\hamcrest-3.0.jar;%APP_HOME%\lib\junit-4.13.2.jar
